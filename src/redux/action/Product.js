...
export const fetchProduct = (category,sort,search) =>{
    return  dispatch =>{
            try {
                Axios.get(urlProduct)
                .then(res=>
                    dispatch( showListProduct(res.data,category,sort,search) ))   
            }
             catch (error) {
...
export const showListProduct = (listProduct,category,sort,search) => {
    return {
